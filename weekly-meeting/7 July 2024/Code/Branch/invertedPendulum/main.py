...
if __name__ == '__main__':
    ...
    if True:
        ...
        model_path = "C:/Users/saber/OneDrive/Desktop/Research/Pablo-Marek-Begum/Weekly Meeting/7 July 2024/Code/Branch/invertedPendulum/finalModel.pth"
        ...
        if True:
            ...
            test.controller = test.trop#test.trop#test.cbfqp #test.ip_clf # test.fbLinController
            test.tend = 10
            test.simulate()
            test.moduloSpin()
            test.plot(data_output_path)
