...
if __name__ == '__main__':
    ...
    if True:
        ...
        test = InvertedPendulum(x0)    # ODE Simulation 
        ip = PendulumEnv()             # pendulum_visualizer  gym 
        ...
        if True:
            ...
            test.controller = test.fbLinController #test.cbfqp #test.ip_clf # test.fbLinController
